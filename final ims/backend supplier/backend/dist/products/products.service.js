...
let ProductsService = class ProductsService {
    ...
    create(createProductDto) {
        ...
        const sku = this.normalizeSku(createProductDto.sku || this.generateNextSku(products));
    ...
    addFeedback(sku, createProductFeedbackDto) {
        const products = this.getProducts();
    ...
    applyInventoryAdjustment(sku, qtyDelta, preferredStoreId) {
        const products = this.getProducts();
    ...
    buildProductRecord(payload, options) {
        ...
        const nextStoreInventory = this.resolveStoreInventory(payload.storeInventory, existing?.storeInventory, qty);
    ...
    resolveStoreInventory(nextEntries, existingEntries, totalQty) {
    ...
    ensureUniqueSku(products, sku, ignoreId) {
    ...
    generateNextSku(products) {
        const nextValue = products.reduce((max, product) => {
