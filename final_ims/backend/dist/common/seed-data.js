...
exports.INITIAL_DB = void 0;
const PRIMARY_STORES = ['s1', 's3', 's7'];
function encodeSvg(svg) {
    return `data:image/svg+xml;utf8,${encodeURIComponent(svg)}`;
}
function buildCardSvg(title, subtitle, emoji, background) {
    return encodeSvg(`<svg xmlns="http://www.w3.org/2000/svg" width="960" height="720" viewBox="0 0 960 720">
...
function buildAvatarSvg(name, background) {
    const initials = String(name || 'RM')
        ...
        .slice(0, 2)
        .toUpperCase();
    return encodeSvg(`<svg xmlns="http://www.w3.org/2000/svg" width="240" height="240" viewBox="0 0 240 240">
...
function cloneStoreInventory(entries) {
    return entries.map((entry) => ({ ...entry }));
}
function distributeStoreInventory(totalQty) {
    ...
    return PRIMARY_STORES.map((storeId, index) => {
        const qty = index === PRIMARY_STORES.length - 1
            ? remaining
...
function buildRatingBreakdown(feedback) {
...
const PRODUCT_SEEDS = [
    {
        ...
        description: 'A balanced everyday laptop for office work, studies, and multitasking with SSD storage and dependable battery life.',
        highlights: [
    ...
    },
    {
        ...
        description: 'Wireless over-ear headphones with active noise cancellation and a travel-friendly foldable design.',
        highlights: [
    ...
    },
    {
        ...
        description: 'Basketball-inspired high-top sneakers with cushioned midsoles and everyday streetwear appeal.',
        highlights: [
    ...
    },
    {
        ...
        description: 'A GPS-enabled smartwatch focused on fitness tracking, health monitoring, and quick iPhone pairing.',
        highlights: [
    ...
    },
    {
        ...
        description: 'A compact smart speaker for voice commands, timers, casual music playback, and simple routines.',
        highlights: [
    ...
    },
    {
        ...
        description: 'A soft upholstered lounge chair with supportive foam cushioning and an inviting living-room profile.',
        highlights: [
    ...
    },
    {
        ...
        description: 'A structured satchel with polished hardware, compact proportions, and practical everyday storage.',
        highlights: [
            'Textured finish',
    ...
    },
    {
        ...
        description: 'A flagship smartphone with a smooth display, high-end cameras, and strong day-to-day performance.',
        highlights: [
    ...
    },
    {
        ...
        description: 'An ergonomic gaming chair with lumbar support, recline control, and dense padding for long sessions.',
        highlights: [
            'Adjustable recline',
    ...
    },
    {
        ...
        description: 'A commuter-friendly backpack with organized compartments, padded straps, and a laptop sleeve.',
        highlights: [
    ...
    },
    {
        ...
        description: 'Premium noise-cancelling headphones with detailed audio tuning and smart ambient modes.',
        highlights: [
    ...
    },
    {
        ...
        description: 'A lightweight productivity laptop with Apple silicon performance, strong battery life, and silent operation.',
        highlights: [
    ...
    },
    {
        ...
        description: 'Slim tapered denim with stretch comfort and a dependable all-day wearable fit.',
        highlights: [
            'Slim tapered fit',
            'Stretch denim blend',
    ...
    },
    {
        ...
        description: 'A cordless vacuum with strong suction, useful attachments, and a lightweight format for fast cleanups.',
        highlights: [
    ...
    },
    {
        ...
        description: 'A performance running shoe with responsive cushioning, breathable mesh, and a lightweight trainer setup.',
        highlights: [
...
function buildProduct(seed, index) {
    ...
    const ratingCount = ratingBreakdown[1] +
        ratingBreakdown[2] +
        ratingBreakdown[3] +
        ratingBreakdown[4] +
        ratingBreakdown[5];
    const ratingAvg = ratingCount
        ? Number(((ratingBreakdown[1] * 1 +
            ratingBreakdown[2] * 2 +
            ratingBreakdown[3] * 3 +
            ratingBreakdown[4] * 4 +
            ratingBreakdown[5] * 5) /
    ...
    const productImg = buildCardSvg(seed.name, `${seed.category} • ${seed.sku}`, seed.emoji, background);
    const galleryImages = [0, 1, 2].map((galleryIndex) => buildCardSvg(seed.name, `${seed.subcategory} • View ${galleryIndex + 1}`, seed.emoji, seed.palette[galleryIndex % seed.palette.length] || background));
    return {
    ...
    users: [
        {
            id: 'user-admin-1',
            name: 'Super Admin',
            email: 'admin@stockoverflow.local',
            password: 'admin123',
            role: 'admin',
            status: 'active',
