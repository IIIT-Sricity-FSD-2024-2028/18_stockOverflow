...
export declare class CustomersController {
    ...
    findAll(retailerId?: string, storeId?: string): import("../common/database.types").CustomerRecord[];
    findOne(id: string, retailerId?: string, storeId?: string): import("../common/database.types").CustomerRecord;
