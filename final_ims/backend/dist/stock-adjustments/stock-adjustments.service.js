...
let StockAdjustmentsService = class StockAdjustmentsService extends collection_service_1.JsonCollectionService {
    ...
    findAll(retailerId, storeId) {
        return this.findAllTyped().filter((adjustment) => this.matchesScope(adjustment, retailerId, storeId));
    }
    create(createStockAdjustmentDto) {
        const product = this.productsService.findBySku(createStockAdjustmentDto.productSku, createStockAdjustmentDto.retailerId, createStockAdjustmentDto.storeId);
        ...
        const qtyDelta = createStockAdjustmentDto.type === 'add'
            ...
            : -createStockAdjustmentDto.qty;
        this.productsService.applyInventoryAdjustment(product.sku, qtyDelta, createStockAdjustmentDto.storeId || this.resolvePreferredStoreId(product), createStockAdjustmentDto.retailerId);
    ...
    matchesScope(adjustment, retailerId, storeId) {
