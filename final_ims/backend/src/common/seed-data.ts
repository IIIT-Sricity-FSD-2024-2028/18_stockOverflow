  ...
  subscriptions: [
    {
      id: 'sub-ret-1',
      userId: 'u-retailer-1',
      userName: 'John Retailer (FreshCart)',
      ...
      status: 'active',
      autoRenew: true,
      paymentId: 'PAY-SO-109283',
      paymentMethod: 'UPI AutoPay',
      features: ['Up to 5 Retail Outlets', 'Unlimited Products & SKUs', 'Automated Reorder Suggestions', 'Multi-Store Inventory Sync', 'Priority Staff Verification'],
      maxStores: 5,
      maxProducts: 10000,
    },
    {
      ...
      userName: 'Metro Mart Supermarket',
      userEmail: 'retailer@stockoverflow.com',
      userRole: 'retailer',
      tier: 'enterprise',
      tierName: 'Enterprise',
      pricePerMonth: 3499,
      ...
      status: 'active',
      autoRenew: true,
      paymentId: 'PAY-SO-992014',
      paymentMethod: 'Corporate Card',
      features: ['Unlimited Stores & Depots', 'Multi-Warehouse Stock Routing', 'Custom ERP & API Integrations', 'Dedicated 24/7 Account Manager', 'Advanced Analytics & Forecasts'],
      maxStores: 999,
      maxProducts: 999999,
    },
  ],
