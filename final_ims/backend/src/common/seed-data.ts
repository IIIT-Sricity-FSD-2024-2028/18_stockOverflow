  ...
  subscriptions: [
    {
      id: 'sub-ret-1',
      userId: 'u-retailer-1',
      userName: 'John Retailer (FreshCart Kirana)',
      ...
      status: 'active',
      features: ['Up to 5 Retail Outlets', 'Unlimited Products & SKUs', 'GST E-Invoice & e-Way Bill', 'WhatsApp & SMS Stock Alerts', 'Automated Reorder Suggestions'],
      maxStores: 5,
      maxProducts: 10000,
    },
    {
