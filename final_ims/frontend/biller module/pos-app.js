(async function () {
  ...
  function generateBill(transaction) {
    ...
    return [
      ...
      '-----------------------------------',
      'Platform Fee (2%): ' + formatInr(transaction.platformFee || Number((transaction.finalTotal * 0.02).toFixed(2))),
      'Net Retailer Settlement: ' + formatInr(transaction.netRetailerAmount || Number((transaction.finalTotal * 0.98).toFixed(2))),
      '-----------------------------------',
      '',
