/**
 * ProductCard_consumer.jsx - Product Card Component for Catalog and Storefront
 * 
 * IN LAYMAN'S TERMS:
 * Renders an individual product box with its image, brand, title, SKU, star rating,
 * price, stock status badge, and "View Details" / "+ Cart" buttons.
 */
...
export default function ProductCard_consumer({ product, onViewProduct, onAddToCart }) {
